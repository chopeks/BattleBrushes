...
void PrintOutput(std::wstringstream &stream)
{
	std::wstring str = stream.str();
	int count = WideCharToMultiByte(CP_UTF8, 0, str.c_str(), str.length(), NULL, 0, NULL, NULL);
	char* utf8 = new char[count+1];
	count = WideCharToMultiByte(CP_UTF8, 0, str.c_str(), str.length(), utf8, count, NULL, NULL);
	utf8[count] = 0;
